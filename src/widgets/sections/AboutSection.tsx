      ...
      <Reveal className="relative">
        <header className="relative">
          <div className="gap-3">
            ...
            <p className="section-eyebrow">NE YAPIYORUM</p>
          </div>
          ...
          <div className="mx-auto mt-14 max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-mist-300 md:text-lg">
              Bir iş ya da fikri geliştirirken yalnızca görünümüne değil, aynı zamanda yapısının
              düzgün çalıştığından emin olduğum, sistemler arası veri akışına ve sürdürülebilir bir
              mimari oluşturmak için üzerinde çalıştığım temel alanlar aşağıda yer alıyor.
            </p>
