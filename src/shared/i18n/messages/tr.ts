...
export const tr: Messages = {
  ...
  about: {
    ...
    title: "Günlük olarak neler üzerinde çalışıyorum?",
    description:
      "Bir iş ya da fikri geliştirirken yalnızca görünümüne değil, aynı zamanda yapısının düzgün çalıştığından emin olduğum, sistemler arası veri akışına ve sürdürülebilir bir mimari oluşturmak için üzerinde çalıştığım temel alanlar aşağıda yer alıyor.",
  },
  skills: {
    eyebrow: "YETENEKLER VE TEKNOLOJİLER",
    title: "Teknolojiler, araçlar ve çalışma pratiğim",
    description:
      "Günlük üretim sürecimde aktif olarak kullandığım teknolojileri ve geliştirme yaklaşımımı bu alanda bir araya getirdim. Amacım sadece hangi araçları kullandığımı değil, ürün geliştirirken nasıl düşündüğümü de sade bir dille göstermek.",
    coreStack: "Ana Yetkinlikler",
    notesEyebrow: "Çalışma Notları",
    notesTitle: "Nasıl çalıştığımı anlatan küçük detaylar",
  },
  projects: {
  ...
  footer: {
    copyright: "© 2026 Oğuz. Tüm hakları saklıdır.",
  },
  content: {
    aboutCapabilities: [
      {
        number: "01",
        title: "Frontend Geliştirilmesi",
        description:
      ...
      {
        number: "02",
        title: "Kullanıcı Deneyimi & Arayüz Tasarımı",
        description:
      ...
      {
        number: "04",
        title: "Mimari & Ürün Odaklı Geliştirme",
        description:
    ...
    capabilitySentences: [
      ...
      {
        number: "03",
        text: "Deneyimi sadece görsel düzen üzerinden değil, kullanıcı yolculuğu ve karar noktaları üzerinden de değerlendirmeyi önemsiyorum.",
        tags: [
    ...
    projects: [
      ...
      },
      {
        ...
        imageLabel: "Fitness takip sistemi önizlemesi",
        overview: {
          problem:
      ...
      },
      {
        ...
        imageLabel: "Portfolyo web sitesi önizlemesi",
        overview: {
          problem:
        ...
        implementation: {
          architecture:
            "Responsive tasarım, animasyonlar ve bileşenleri modüler bir yapıda geliştirerek performans ve kullanıcı deneyimini dengeledim. Yapı itibarıyla temiz ve yeniden kullanılabilir değişkenler kullanarak verimi sağladım.",
        },
      },
    ],
    experiences: [
